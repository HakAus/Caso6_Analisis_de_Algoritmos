...
World.prototype.init = function() {
	...
	this.flock = new Flock(this.scene, this.octree, this.obstacles, 10);
	...
	this.min_velocity_control = this.bc.add(this, "min_velocity", 0, 3);
	this.max_velocity_control = this.bc.add(this, "max_velocity", 4, 10);
